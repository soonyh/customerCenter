...
export default {
  ...
  'menu.other': '其他部件',
  'menu.works': '工作台管理',
  'menu.works.custviewfunmodule': '客户视图功能模块',
  'menu.works.custviewtemplate': '客户视图模板',
  'menu.works.rolefunmodule': '角色功能模板',
  'menu.works.roletemplate': '角色模板',
  'menu.works.userfunmodule': '用户功能模板',
  'menu.works.usertemplate': '用户模板',
  'menu.works.infoitem': '信息项管理',
  'menu.works.infoblock': '信息块管理',
  'menu.works.infoitemorblock': '信息项与信息块管理',
  'menu.flowcheck':'流程审核',
  'menu.tasks1':'待办待阅',
  /* */
  ...
  welcomeLogin: '欢迎登录',
  jobNumber: '工号',
  jobNumberHelp: '请输入用户名',
  password: '密码',
  passwordHelp: '数字、字母或下划线，长度>=6',
  forgotPassword: '忘记密码',

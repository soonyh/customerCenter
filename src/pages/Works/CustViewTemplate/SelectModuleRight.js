...
const mapDispatchToProps = (dispatch) => {
  return {
    deleteSelectModuleRight:()=>{
        const action={
            type: `${namespace}/deleteSelectModuleRight`,
          };
        dispatch(action);
    }
  };
...
class SelectModuleRight extends React.Component {
    constructor(props) {
      super(props);
      this.state = {
      ...
      return (
        <Card className={`${styles.CardcenterSelect}`} style={{marginBottom:16}}>
            ...
            <Row style={{marginTop:8}}>
                ...
                <Col span={12}><Button onClick={()=>this.props.deleteSelectModuleRight()}>删除</Button></Col>
            </Row>
        </Card> 
      );
    }
  ...
  export default  SelectModuleRight;

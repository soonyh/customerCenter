...
const localeInfo = {
  'en-US': {
    messages: require('E:/weiyun/apache-tomcat-7.0.86-windows-x64/webapps/work/front/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'zh-CN': {
    messages: require('E:/weiyun/apache-tomcat-7.0.86-windows-x64/webapps/work/front/src/locales/zh-CN.js').default,
    locale: 'zh-CN',

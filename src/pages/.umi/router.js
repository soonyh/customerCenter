...
let routes = [
  ...
  },
  {
    ...
    "routes": [
      ...
      {
        "component": () => React.createElement(require('E:/weiyun/apache-tomcat-7.0.86-windows-x64/webapps/work/front/node_modules/_umi-build-dev@1.2.5@umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: true }),
        "_title": "政企客户中心",
        "_title_default": "政企客户中心"
      }
    ],
